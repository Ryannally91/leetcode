...
def processLogs(logs, threshold):
    ...
    # sorted(trans.keys())
    return sorted(i for i in trans if trans[i] >= threshold)
#THIS works but getting runtime error
#try using ordered dict
print(processLogs(['313 2 10', '33 2 10', '3 3 10', '3 1 10'], 1))